...
class Config:
    ...
    # Object storage for digital merch uploads (S3 / R2 / GCS-compatible)
    OBJECT_STORAGE_PROVIDER = (_env('OBJECT_STORAGE_PROVIDER') or 's3').lower()
    OBJECT_STORAGE_BUCKET = _env('OBJECT_STORAGE_BUCKET')
    OBJECT_STORAGE_REGION = _env('OBJECT_STORAGE_REGION') or 'us-east-1'
    OBJECT_STORAGE_ENDPOINT_URL = _env('OBJECT_STORAGE_ENDPOINT_URL')
    OBJECT_STORAGE_ACCESS_KEY_ID = _env('OBJECT_STORAGE_ACCESS_KEY_ID')
    OBJECT_STORAGE_SECRET_ACCESS_KEY = _env('OBJECT_STORAGE_SECRET_ACCESS_KEY')
    OBJECT_STORAGE_PUBLIC_BASE_URL = _env('OBJECT_STORAGE_PUBLIC_BASE_URL')
    OBJECT_STORAGE_FORCE_PATH_STYLE = _bool_env('OBJECT_STORAGE_FORCE_PATH_STYLE', False)
    OBJECT_STORAGE_SIGNED_URL_EXPIRES_SECONDS = int(os.environ.get('OBJECT_STORAGE_SIGNED_URL_EXPIRES_SECONDS') or '600')
    MERCH_UPLOAD_MAX_FILE_SIZE_BYTES = int(os.environ.get('MERCH_UPLOAD_MAX_FILE_SIZE_BYTES') or str(5 * 1024 * 1024 * 1024))
    MERCH_UPLOAD_SMALL_FILE_THRESHOLD_BYTES = int(os.environ.get('MERCH_UPLOAD_SMALL_FILE_THRESHOLD_BYTES') or str(64 * 1024 * 1024))
    MERCH_UPLOAD_PART_SIZE_BYTES = int(os.environ.get('MERCH_UPLOAD_PART_SIZE_BYTES') or str(16 * 1024 * 1024))
    MERCH_UPLOAD_SESSION_TTL_MINUTES = int(os.environ.get('MERCH_UPLOAD_SESSION_TTL_MINUTES') or '120')
    MERCH_UPLOAD_BATCH_SIZE = int(os.environ.get('MERCH_UPLOAD_BATCH_SIZE') or '100')
